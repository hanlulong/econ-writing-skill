...
All CORE PRINCIPLES, STYLE RULES, and section formulas in [SKILL.md](SKILL.md) still apply -- this file only adds task-specific guidance. Read SKILL.md first for the general rules, then apply the relevant block below.
